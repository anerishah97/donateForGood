...
<nav class="main-nav-outer" id="test"><!--main-nav-start-->
	<div class="container">
        <ul class="main-nav">
           ...
           <li>
                                <button class="sign-in-btn" id="myBtn">Sign Up</button>
                                </li>
        </ul>
...
<header class="header" id="header"><!--header-start-->
	...
	<div class="container">
        ...
        <video id="videoId" class="bg-video" preload="auto" autoplay="true" poster="img/pw_maze_black_2X.png">
        ...
        <h1 class="animated fadeInDown delay-07s">Welcome To DFG</h1>
...
<div id="myModal" class="modal">
 ...
 <div class="form">
      ...
      <ul class="tab-group">
        <h2>
        <li class="tab active"><h3><a href="#signup"></a></h3></li>
        <li class="tab"><h3><a href="#login">I Already have an account!</a></h3></li>
        </h2>
      </ul>
      ...
      <div class="tab-content">
        <div id="signup">   
           <h2>New To DFG?</h2>
                     <form action="registration.php" method="post" role="form" class="contactForm">
                        <div class="form-group">
                            <input type="text" name="firstname" class="form-control input-text" id="firstname" placeholder="First Name" data-rule="minlen:3" data-msg="Please enter at least 4 chars" />
                            <div class="validation"></div>
                        </div>

                        
                         <div class="form-group">
                            <input type="text" name="lastname" class="form-control input-text" id="lastname" placeholder="Last Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                            <div class="validation"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="text-center"><button type="submit" class="input-btn">Sign up</button></div>
                    </form>
    ...
    <div class="portfolioContainer wow fadeInUp delay-04s">
                ...
                <div class=" Portfolio-box photography" >
                    <a href="#"><img src="images/belts.jpg" alt=""></a>   
                                ...
                                <div class="text-center"><button class="input-btn" id='myBtn2'>Donate now</button></a>
                                </div>
